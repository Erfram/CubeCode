...
import static com.cubecode.CubeCodeClient.scriptExecutor;
...
public class ClientScript implements Script {
    ...
    public ClientScript(String name, String code, List<String> libraries) {
        this.name = name;
        this.code = code;
    ...
    public void run(String function, String sourceName, ClientProperties properties) throws CubeCodeException {
        ...
        try {
            this.libraries.forEach(library -> {
                ServerScript script = CubeCode.projectManager.getScript(library);
                if (script != null) {
    ...
    public void evaluate() throws CubeCodeException {
        scriptExecutor.evaluate(this.context, this.scope, this.code, this.name);
    }
