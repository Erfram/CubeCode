...
public class ImGuiScreen extends Screen {
    protected ImGuiScreen(Text title, View view) {
        super(title);
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double amount) {
        ImGuiLoader.IMGUI_GLFW.scrollCallback(MinecraftClient.getInstance().getWindow().getHandle(), amount, amount);
        ImGuiLoader.handleScroll(mouseX, mouseY, amount, amount);
