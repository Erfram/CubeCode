...
public class SettingManager extends DirectoryManager {
    ...
    public void addScript(String scriptName, Script.Type side) {
        this.settings.put(scriptName, new ScriptSetting(side));

        this.write();
    }

    public void setScriptSide(String scriptName, Script.Type side) {
        ScriptSetting scriptSetting = this.settings.get(scriptName);
    ...
    public ConcurrentHashMap<String, ScriptSetting> jsonToSettings(JsonObject jsonObject) {
        ...
        jsonObject.keySet().forEach(key -> {
            ...
            settings.put(key, new ScriptSetting(
                    Script.Type.valueOf(jsonScriptSetting.get("Side").getAsString().toUpperCase()),
                    libraries,
    ...
    public static class ScriptSetting {
        ...
        public ScriptSetting(Script.Type side, List<String> libraries, int lastLaunchErrorLine, String lastLaunchErrorMessage) {
            this.side = side;
        ...
        public ScriptSetting(Script.Type side, List<String> libraries) {
            this.side = side;
            this.libraries = libraries;
        ...
        public ScriptSetting(Script.Type side) {
            this.side = side;
